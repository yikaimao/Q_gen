...
| Quantum Search Algorithms            | Grover's Algorithm                         | ```[num_solutions, print_solutions]```        | [[8]](https://github.com/Qiskit/textbook/blob/main/notebooks/ch-algorithms/grover.ipynb)                                                                                                                                                                                                    |
